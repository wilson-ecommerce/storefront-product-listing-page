      ...
      >
        ...
        {isDropdownOpen && (
          <ul
            ref={listRef}
            tabIndex={-1}
            className="ds-sdk-sort-dropdown__items origin-top-right absolute hover:cursor-pointer top-0 w-full rounded-2 shadow-2xl bg-white ring-1 ring-black ring-opacity-5 focus:outline-none mt-2 z-20"
          >
